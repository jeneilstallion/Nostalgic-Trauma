...
func checkAge() {
    ...
    sleep(2)
    print("Well isnt this a suprise, I said with malice i my voice. Detective Raven my captor.")
    sleep(2)
    ...
    sleep(2)
    print("\(checkAge()) AND YOU DARE TO COME IN HERE AND STILL ASK FOR MY HELP!!")
    sleep(2)
